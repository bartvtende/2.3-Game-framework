...
public class CircleShape extends JPanel {
	...
	private void doDrawing(Graphics g){
		...
		g.setColor(background);
		g.fillOval(new Double(PointsX[2]).intValue(), new Double(PointsY[2]).intValue() , new Double(PointsX[3]-PointsX[2]).intValue(), new Double(PointsY[3]-PointsY[2]).intValue());
	}
